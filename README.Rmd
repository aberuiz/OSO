...
You can save your API Key into the system environment by using 'beaSetKey'

```{r eval=FALSE}
beaSetKey("<Your 36 character API Key>")
```

You can recall your API Key by using 'beaGetKey'
